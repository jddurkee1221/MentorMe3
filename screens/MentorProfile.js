...
import { Header, Content, Card, CardItem, Thumbnail, Text, Button, Icon, Left, Body, Title, Right } from 'native-base';
                    ...
                    <CardItem>
                        <Left>
                            <Body>
                                ...
                                <Text style={{ paddingVertical: 3 }}>Blah Blah Blah Im so interesting</Text>
                            </Body>
                        </Left>
                        <Right>
                            <Body>
